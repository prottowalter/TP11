...
- A.
- **Declara** el prototipo de la **función** *printf* que devuelve un *int* con el primer parámetro de **tipo puntero const** a *char* y luego una **cantidad indefinida de parametros** de cualquier tipo.
